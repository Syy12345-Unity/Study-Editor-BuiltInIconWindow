...
public class BuiltInIconWindow : EditorWindow {
    [MenuItem("Tool/BuiltInIconWindow")]
        ...
        using(var scroll = new EditorGUILayout.ScrollViewScope(m_scrollPos))
        {
            ...
            foreach (var iconName in m_iconNames)
            {
                using(new EditorGUILayout.HorizontalScope())
                {
                    ...
                    GUILayout.Box(image, GUILayout.Width(100));
                    EditorGUILayout.TextField(iconName);
                    EditorGUILayout.TextField(image.width + "x" + image.height);
